...
<body class="bg-surface text-on-surface flex min-h-screen">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
                                <div class="md:col-span-2 flex flex-col gap-xs">
                                    <form action="action.php?aksi=update" method="post" enctype="multipart/form-data">
                                        ...
                                        <label class="font-label-md text-on-surface-variant">Product Name</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. Nike" type="text" name="nama_product" value="<?= $data['nama'] ?>" />
                                        <label class="font-label-md text-on-surface-variant">Price</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. Rp 2000" type="text" name="price" value="<?= $data['harga'] ?>" />
                                        <label class="font-label-md text-on-surface-variant">Deskripsi</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. Nike" type="text" name="deskripsi" value="deskripsi" />
                                        <label class="font-label-md text-on-surface-variant">Image Product</label>

                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. Nike" type="file" name="image" value="<?= $data['image'] ?>" id="input_image" />
                                        <br>
                                        <img src="./image_product/<?= $data['image'] ?>" alt="" width="100" id="image_product">
                                        <label class="font-label-md text-on-surface-variant">Stock</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. Nike" type="text" name="stok" value="<?= $data['stok'] ?>" />
                                        <label class="font-label-md text-on-surface-variant">Category</label>
                                        <select class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" name="id_category" id="">
                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <option value="<?= $row['id'] ?>" <?= $row['id'] == $data['id_category'] ? 'selected' : '' ?>><?= $row['nama'] ?></option>
    ...
    <script>
        const image = document.getElementById('image_product');

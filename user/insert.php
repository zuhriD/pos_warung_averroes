        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-6 bg-surface-container-lowest">
            ...
            <div class="w-full max-w-5xl">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-lg gap-4">
                    <div>
                        <h1 class="font-headline-lg text-on-surface">Add New User</h1>
                        <p class="text-body-md text-on-surface-variant">Create a new entry for your store's users.</p>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
                                <div class="md:col-span-2 flex flex-col gap-xs">
                                    <form action="action.php?aksi=insert" method="post">
                                        ...
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. John Doe" type="text" name="nama" />
                                        
                                        <label class="font-label-md text-on-surface-variant mt-3">Alamat</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. Jl. Raya..." type="text" name="alamat" />
                                        
                                        <label class="font-label-md text-on-surface-variant mt-3">No HP</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. 08123456789" type="text" name="no_hp" />
                                        
                                        <label class="font-label-md text-on-surface-variant mt-3">Username</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. johndoe" type="text" name="username" />

                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-slate-50 border-b border-slate-100">
                                ...
                                <th class="px-6 py-4 text-label-md font-label-md text-slate-500 uppercase tracking-wider">Nama User</th>
                                <th class="px-6 py-4 text-label-md font-label-md text-slate-500 uppercase tracking-wider">Alamat</th>
                                <th class="px-6 py-4 text-label-md font-label-md text-slate-500 uppercase tracking-wider">No HP</th>
                                <th class="px-6 py-4 text-label-md font-label-md text-slate-500 uppercase tracking-wider">Username</th>
                                <th class="px-6 py-4 text-label-md font-label-md text-slate-500 uppercase tracking-wider">Role</th>
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            ?>
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-2 py-1"><?= $row['alamat'] ?></span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="px-2 py-1"><?= $row['no_hp'] ?></span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="px-2 py-1"><?= $row['username'] ?></span>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            <a class="p-2 text-slate-400 hover:text-error transition-colors" href="action.php?aksi=delete&id=<?= $row['id'] ?>" onclick="return confirm('Apakah anda yakin mau menghapus user ini?')"><span class="material-symbols-outlined" data-icon="delete">delete</span></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php

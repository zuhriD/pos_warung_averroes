        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-6 bg-surface-container-lowest">
            ...
            <div class="w-full max-w-5xl">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-lg gap-4">
                    <div>
                        <h1 class="font-headline-lg text-on-surface">Edit User</h1>
                        <p class="text-body-md text-on-surface-variant">Edit user to your store's users.</p>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
                                <div class="md:col-span-2 flex flex-col gap-xs">
                                    <form action="action.php?aksi=update" method="post">
                                        ...
                                        <label class="font-label-md text-on-surface-variant">User Name</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. John Doe" type="text" name="nama" value="<?= $data['nama'] ?>" />
                                        
                                        <label class="font-label-md text-on-surface-variant mt-3">Alamat</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. Jl. Raya..." type="text" name="alamat" value="<?= $data['alamat'] ?>" />
                                        
                                        <label class="font-label-md text-on-surface-variant mt-3">No HP</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. 08123456789" type="text" name="no_hp" value="<?= $data['no_hp'] ?>" />
                                        
                                        <label class="font-label-md text-on-surface-variant mt-3">Username</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. johndoe" type="text" name="username" value="<?= $data['username'] ?>" />
                                        
                                        <label class="font-label-md text-on-surface-variant mt-3">Password</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. ********" type="password" name="password" value="<?= $data['password'] ?>" />
                                        
                                        <label class="font-label-md text-on-surface-variant mt-3">Role</label>
                                        <select name="id_role" class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none">
                                            <?php
                                            $roles = showDataRole($conn);
                                            while ($r = $roles->fetch_assoc()) {
                                                $selected = ($r['id'] == $data['id_role']) ? 'selected' : '';

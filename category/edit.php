        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-6 bg-surface-container-lowest">
            ...
            <div class="w-full max-w-5xl">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-lg gap-4">
                    <div>
                        <h1 class="font-headline-lg text-on-surface">Edit Category</h1>
                        <p class="text-body-md text-on-surface-variant">Edit category to your store's categorys.</p>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
                                <div class="md:col-span-2 flex flex-col gap-xs">
                                    <form action="action.php?aksi=update" method="post">
                                        ...
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. Admin" type="text" name="nama_category" value="<?= $data['nama'] ?>" />

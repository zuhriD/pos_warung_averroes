             ...
             <div class="w-full max-w-5xl">
                 ...
                 <div class="flex flex-col md:flex-row md:items-center justify-between mb-lg gap-4">
                     <div>
                         ...
                         <p class="text-body-md text-on-surface-variant">Edit the category information.</p>
                     </div>
                             ...
                             <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
                                 <div class="md:col-span-2 flex flex-col gap-xs">
                                     <form action="action.php?aksi=update" method="post">
                                         ...
                                         <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. Snacks" type="text" name="nama_kategori" value="<?= $data['nama']; ?>" />

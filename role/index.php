                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-slate-50 border-b border-slate-100">
                                ...
                                <th class="px-6 py-4 text-label-md font-label-md text-slate-500 uppercase tracking-wider">Nama Role</th>
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            ?>
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-2 py-1 bg-emerald-50 text-emerald-700 text-label-md rounded-full"><?= $row['name'] ?></span>
                                    </td>
